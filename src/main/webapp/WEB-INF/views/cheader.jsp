...
<body >
  ...
  <a class="navbar-brand" href="#"><font color="green" style="font-size:30px">Stock Exchange</font></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav" style="background-color:Gray;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/cmpregister">Listing</a>
      </li>
      </c:if>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/stockholders">Stock Holders</a>
      </li>
      <li class="nav-item">
